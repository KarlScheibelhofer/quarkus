...
/**
 * Test client-auth type required.
 */
public class SslClientWithP12RequiredTest {

    @RegisterExtension
    static final QuarkusUnitTest config = new QuarkusUnitTest()
            .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
                    .addClasses(MyBean.class)
                    .addAsResource(new File("src/test/resources/conf/ssl-client-required-p12.conf"), "application.properties")
                    .addAsResource(new File("src/test/resources/conf/server-keystore.jks"), "server-keystore.jks")
                    .addAsResource(new File("src/test/resources/conf/truststore.p12"), "truststore.p12"));
    ...
    @Test
    public void testSslClientWithJKS() throws MalformedURLException, Exception {
